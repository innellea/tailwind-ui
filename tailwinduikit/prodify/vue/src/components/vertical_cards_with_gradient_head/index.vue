<template>
    <div class="mx-auto container px-4 xl:px-0 pt-16 lg:pt-36">
        <div class="flex flex-col w-full items-center justify-center f-f-l">
            <div class="bg-white w-full xl:w-11/12 px-6 py-8 xl:px-16 lg:py-16 shadow-lg rounded-lg">
                <div class="lg:flex justify-between w-full">
                    <div>
                        <div class="flex w-full justify-between lg:justify-start items-center">
                            ...
                            <button class="w-10 h-10 bg-button-color-about-us flex items-center justify-center rounded-full">
                    ...
                    <div class="pt-8 lg:pt-0 flex items-center flex-col">
                        ...
                        <button class="py-4 px-4 xl:px-10 bg-button-color-about-us f-f-r text-xl font-bold text-color mt-7">Start Free Trial</button>
                    </div>
                </div>
            </div>
            <div class="bg-white w-full xl:w-11/12 px-6 py-8 xl:px-16 lg:py-16 mt-12 shadow-lg rounded-lg">
                <div class="lg:flex justify-between w-full">
                    <div>
                        <div class="flex w-full justify-between lg:justify-start items-center">
                    ...
                    <div class="pt-8 lg:pt-0 flex items-center flex-col">
                        ...
                        <button class="py-4 px-4 xl:px-10 bg-linear-button-about-us f-f-r text-xl font-bold text-white mt-7">Start Free Trial</button>
                    </div>
                </div>
            </div>
            <div class="bg-white w-full xl:w-11/12 px-6 py-8 xl:px-16 lg:py-16 mt-12 shadow-lg rounded-lg">
