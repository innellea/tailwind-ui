<template>
    <div class="mx-auto container">
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:pb-10 mt-40">
            <div class="bg-white px-6 py-6 text-color f-f-l shadow-lg">
