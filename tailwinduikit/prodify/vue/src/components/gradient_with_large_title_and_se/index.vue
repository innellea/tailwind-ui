    ...
    <div class="bg-linear-about-us">
        <div class="mx-auto container">
                ...
                <div class="relative z-10 mx-auto container hidden w-full px-4 xl:px-0 lg:flex justify-between items-center py-11">
                    ...
                    <div class="flex items-center text-white text-lg font-bold">
                        <ul class="flex items-center pr-12">
                            ...
                            <router-link to="/AboutUs">
                                <li class="xl:pl-8 lg:pl-5 cursor-pointer text-color-1">About Us</li>
                            </router-link>
                            <router-link to="/Pricing">
                                <li class="xl:pl-8 lg:pl-5 cursor-pointer text-color-1">Pricing</li>
                            </router-link>
                            <router-link to="/Resources">
                                <li class="xl:pl-8 lg:pl-5 cursor-pointer text-color-1">Resources</li>
                            </router-link>
                        </ul>
                        <button class="py-3 pl-6 pr-4 bg-white bg-linear-button text-white text-lg font-bold flex items-center justify-center">
                            Sign In
            ...
            <div class="py-12 lg:py-24">
                <h1 class="text-center f-f-l text-white text-4xl md:text-8xl font-black">How can we help?</h1>
                <div class="flex w-full h-full justify-center">
                    <div class="mt-5 md:mt-20 w-9/12 lg:w-6/12 pl-4 md:pl-5 h-full bg-white flex items-center">
                        ...
                        <input class="h-16 md:h-20 w-full text-sm md:text-2xl f-f-r focus:outline-none text-color placeholder-gray-700 placeholder-gray-700" placeholder="Search for whatever you need..." type="text" />
                    </div>
                </div>
            </div>
        </div>
