    ...
    <div class="mx-auto container px-4 lg:px-0">
                ...
                <div class="flex flex-wrap items-center">
                    <div class="lg:w-2/3 w-full xl:pr-20">
                        <div class="py-2 text-color">
                            <h1 class="text-2xl lg:text-6xl lg:leading-snug tracking-tighter f-f-l font-black">
                                {{ titleOne }}
                            </h1>
                            <h2 class="text-lg lg:text-3xl leading-7 lg:leading-10 f-f-r py-4 lg:py-8">
                                {{ description }}
                            </h2>
                    ...
                    <div class="lg:w-1/3 w-full relative min-height-images flex items-end justify-center">
                        <img class="absolute w-full h-full inset-0 object-cover object-center rounded-xl" v-bind:src="imageOne" alt="" />
        ...
        <div class="pt-28 lg:py-28">
            <div class="">
                <div class="flex flex-wrap items-center">
                    <div class="lg:w-1/3 w-full relative min-height-images flex items-end justify-center">
                        <img class="absolute w-full h-full inset-0 object-cover object-center rounded-xl" v-bind:src="imageTwo" alt="" />
                        <div class="relative z-10 bg-white rounded shadow-lg p-6 w-10/12 -mb-20">
                            <div class="flex items-center justify-between w-full sm:w-full mb-8">
                                <div class="flex items-center">
                                    <div class="p-4 bg-yellow-200 rounded-lg">
                    ...
                    <div class="lg:w-2/3 py-24 lg:py-0 w-full lg:pl-20">
                        <div class="py-2 text-color">
                            <h1 class="text-2xl lg:text-3xl lg:text-6xl tracking-tighter lg:leading-snug f-f-l font-black">
                                {{ titleTwo }}
                            </h1>
                            <h2 class="text-lg lg:text-3xl leading-7 lg:leading-10 f-f-r py-8">
                                {{ description }}
                            </h2>
                            <div class="flex items-center cursor-pointer">
                                <h3 class="f-f-r text-2xl font-semibold underline text-color-pink">Lets Get Started</h3>
        ...
        <div class="pb-32">
            <div class="mx-auto">
                <div class="flex flex-wrap items-center">
                    <div class="lg:w-2/3 w-full lg:pr-20">
                        <div class="py-2 text-color">
                            <h1 class="text-2xl lg:text-6xl tracking-tighter lg:leading-snug f-f-l font-black">
                                {{ titleThree }}
                            </h1>
                    ...
                    <div class="lg:w-1/3 w-full relative min-height-images flex items-end justify-center">
                        <img class="absolute w-full h-full inset-0 object-cover object-center rounded-xl" v-bind:src="imageThree" alt="" />
                        <div class="relative z-10 p-4 bg-white shadow-lg rounded mx-auto w-9/12 -mb-20">
                            <h4 class="text-gray-800 font-normal text-lg leading-4 tracking-normal mb-2">Invoice # 35RD87</h4>
                            ...
                            <button class="relative focus:outline-none mt-4 py-2 pr-10 bg-linear-button-home text-white tracking-normal text-xs pl-3 cursor-pointer">
                                View Invoice
