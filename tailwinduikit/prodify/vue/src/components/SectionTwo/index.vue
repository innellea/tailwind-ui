        ...
        <div class="px-4 xl:px-0">
            <div class="container mx-auto">
                <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:pb-10">
                    ...
                    <div class="bg-white px-6 py-6 text-color f-f-l shadow-lg xl:-mt-20">
...
<script>
import SectionThree from "../alternating_description_with_cards/index";
import SectionFour from "../simple-colored-logos/index";
export default {
    name: "SectionTwo",
    components: {
        SectionThree,
