    ...
    <div class="relative w-full h-full">
        ...
        <div class="relative px-4 xl:px-0 container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-16 lg:pt-36 gap-8">
            <div class="text-color">
                ...
                <div class="f-f-r text-xl xl:text-3xl pt-10 xl:pt-20">
                ...
                <button class="text-xl w-full xl:text-3xl xl:w-9/12 mt-4 xl:mt-11 f-f-r py-6 bg-linear-button-home text-white text-bold">Let's Build</button>
            </div>
            <div class="">
