    ...
    return (
        <>
            <div className="relative w-full h-full">
                ...
                <div className="md:hidden">{/* <img className="absolute bg-cover bg-center w-full h-full inset-0" src="https://cdn.tuk.dev/assets/templates/prodify/backgroundMobile.png" alt /> */}</div>
                ...
                <nav className="  f-f-l relative z-10">
                    <div className="relative z-10 mx-auto container hidden w-full px-4 xl:px-0 lg:flex justify-between items-center py-11">
                        ...
                        <div className="flex  items-center text-white text-lg font-bold ">
                            ...
                            <button className="px-6 py-3 bg-white bg-linear-button  text-white text-lg font-bold flex items-center justify-center">
                                Sign In
                ...
                <div className="relative px-4 xl:px-0  container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 pt-16 lg:pt-36 gap-8">
                    <div className="text-color">
                        ...
                        <div className="f-f-r text-xl lg:text-3xl pt-10  xl:pt-20">
                        ...
                        <button className="text-xl w-full xl:text-3xl xl:w-9/12 mt-4 xl:mt-11 f-f-r py-6 bg-linear-button-home text-white text-bold">Let's Build</button>
                    </div>
                    <div className>
