...
function IndexPage() {
    ...
    return (
        <>
            <div className="bg-linear-pink lg:pb-28">
                <div className="mx-auto container ">
                    ...
                    <nav className="f-f-l relative z-10">
                        <div className="relative z-10 mx-auto hidden container w-full lg:px-4 xl:px-0 lg:flex justify-between items-center py-11">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width={79} height={92} viewBox="0 0 79 92" fill="none">
                                    <rect width={79} height={92} fill="#1A202C" />
                                    <path
                            ...
                            <div className="flex  items-center text-color text-lg font-bold ">
                                <ul className="flex  items-center pr-12">
                                    <li className=" cursor-pointer">
                                        {" "}
                                        <a href="/">Home</a>
                                    </li>
                                    <li className="xl:pl-8 lg:pl-5 cursor-pointer text-color-1">
                                ...
                                <button className="py-3 px-6 bg-white bg-linear-button-about-us text-white text-lg font-bold flex items-center justify-center">
                                    Sign In
