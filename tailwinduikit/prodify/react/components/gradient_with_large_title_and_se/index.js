...
function IndexPage() {
    ...
    return (
        <>
            <div className="bg-linear-about-us">
                <div className="mx-auto container">
                        ...
                        <div className="relative z-10 mx-auto container hidden w-full px-4 xl:px-0 lg:flex justify-between items-center py-11">
                            ...
                            <div className="flex  items-center text-white text-lg font-bold ">
                                <ul className="flex  items-center pr-12">
                                    ...
                                    <li className="lg:pl-5 xl:pl-8 cursor-pointer hover:text-gray-300">
                                    ...
                                    <li className="lg:pl-5 xl:pl-8 cursor-pointer hover:text-gray-300">
                                        <a href="/knowledge-base">Resources</a>
                                    </li>
                                </ul>
                                <button className="py-3 pl-6 pr-4 bg-white bg-linear-button  text-white text-lg font-bold flex items-center justify-center">
                                    Sign In
                    ...
                    <div className="py-12 lg:py-24">
                        <h1 className="text-center f-f-l text-white text-4xl md:text-8xl font-black">How can we help?</h1>
                        <div className="flex w-full h-full justify-center">
                            <div className="mt-5 md:mt-20 w-9/12 lg:w-6/12 pl-4 md:pl-5 h-full  bg-white flex items-center">
                                ...
                                <input className="h-16 md:h-20 w-full text-sm  md:text-2xl f-f-r focus:outline-none text-color" placeholder="Search for whatever you need..." type="text" />
                            </div>
                        </div>
                    </div>
                </div>
