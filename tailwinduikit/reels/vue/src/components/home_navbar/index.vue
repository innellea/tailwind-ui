<template>
    <!-- Sidebar starts -->
    <div class="lg:w-96 w-64 fixed z-40 top-0 bg-color-black shadow min-h-screen flex-col justify-between pb-12 transition duration-150 ease-in-out" style="transform: translateX(-500px)" id="mobile-nav">
        <div class="lg:px-6 px-4">
            <div class="lg:px-6 flex items-center justify-between pt-16">
            ...
            <ul class="mt-36">
                <router-link to="/" class="cursor-pointer">
                    <li class="text-base font-bold text-off-white lg:py-6 py-3 lg:px-10 px-5 hover-gold rounded-full">Home</li>
                </router-link>
                <router-link to="/ReelsGallery" class="cursor-pointer">
                    <li 
                        v-bind:class="[{'bg-gold-color text-color-black' :$route.path === '/ReelsGallery'}]"
                        class="text-base font-bold lg:py-6 py-3 text-off-white lg:px-10 px-5 hover-gold rounded-full my-6">Gallery</li>
                </router-link>
                <router-link to="/ReelsContact" class="cursor-pointer">
                    <li 
                        v-bind:class="[{'bg-gold-color text-color-black' :$route.path === '/ReelsContact'}]"
                        class="text-base font-bold text-off-white lg:py-6 py-3 lg:px-10 px-5 hover-gold rounded-full">Contact</li>
                </router-link>
            </ul>
        </div>
    </div>
    <!-- Sidebar ends -->
    <!-- Navbar -->
    <div class="mx-auto container relative xl:px-0 px-4 lg:block hidden">
