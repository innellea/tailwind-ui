...
declare var Chart;
@Component({
    selector: "app-virtual-events-speakers",
    templateUrl: "./virtual-events-speakers.component.html",
    styleUrls: ["./virtual-events-speakers.component.css"],
})
export class VirtualEventsSpeakersComponent implements OnInit {
    constructor() {}
    Interaction = (flag) => {
        if (flag) {
