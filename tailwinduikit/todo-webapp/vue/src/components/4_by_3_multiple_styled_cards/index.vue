<template>
    <div class="mx-auto container py-20 px-6">
        <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div class="rounded">
                <div 
                    v-for="(card, idx) in cards" v-bind:key="idx"
                    class="w-full h-64 flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4"
                    v-bind:class="[card.theme, card.border]"
                >
                    <div>
                        <h4 class="text-gray-800 font-bold mb-3">{{card.title}}</h4>
                        <p class="text-gray-800 text-sm">{{card.desc}}</p>
                    </div>
                    <div>
                ...
                <div class="w-full h-64 flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4">
                    ...
                    <div>
                        <div class="mb-3 flex items-center">
                            <div class="border border-gray-300 rounded-full px-3 py-1 text-gray-600 text-xs flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-alarm" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                    <circle cx="12" cy="13" r="7"></circle>
                                    <polyline points="12 10 12 13 14 13"></polyline>
                            ...
                            <div class="p-1 bg-gray-800 rounded-full ml-2 text-yellow-500">
            ...
            <div class="rounded">
                <div class="w-full h-64 flex flex-col justify-between items-start bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4">
                    <div>
                        <h4 class="text-gray-800 font-bold mb-3">13 things to work on</h4>
                        <p class="text-gray-800 text-sm">Probabo, inquit, sic agam, ut labore et voluptatem sequi
                            nesciunt, neque porro quisquam est, quid malum, sensu iudicari</p>
                ...
                <div 
                    v-for="(card, idx) in cardsTwo" v-bind:key="idx"
                    class="w-full h-64 flex flex-col justify-between rounded-lg border mb-6 py-5 px-4"
                    v-bind:class="[card.theme, card.border]"
                >
                    <div>
                        <h4 class="text-gray-800 font-bold mb-3">13 things to work on</h4>
            ...
            <div class="rounded">
                <div class="w-full h-64 flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4">
                    ...
                    <div>
                        <div class="mb-3 flex items-center">
                            <div class="p-1 bg-gray-800 rounded-full text-yellow-500">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-star" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                    <path d="M12 17.75l-6.172 3.245 1.179-6.873-4.993-4.867 6.9-1.002L12 2l3.086 6.253 6.9 1.002-4.993 4.867 1.179 6.873z"></path>
                                </svg>
            ...
            cards: [
                {
                    ...
                    desc: "Probabo, inquit, sic agam, ut labore et voluptatem sequi nesciunt, neque porro quisquam est, quid malum, sensu iudicari, sed ut alterum.",
                    date: "March 28, 2020",
                },
                {
                    title: "13 things to work on",
