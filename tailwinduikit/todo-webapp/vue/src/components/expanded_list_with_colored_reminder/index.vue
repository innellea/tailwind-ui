<template>
    <div class="flex pt-6 items-center">
        <div data-menu class="cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" aria-label="Hide" class="icon icon-tabler icon-tabler-chevron-up" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#718096" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" />
                <polyline points="6 9 12 15 18 9" />
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" aria-label="Show" class="hidden icon icon-tabler icon-tabler-chevron-down" width="28" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#718096" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<hr class="divider mt-6 border-t border-gray-300" />
<div>
    <div class="flex pt-6 items-center">
        <div data-menu class="cursor-pointer">
