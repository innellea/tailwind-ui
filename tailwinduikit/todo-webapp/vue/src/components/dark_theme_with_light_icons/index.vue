<template>
    <div class="h-full">
        ...
        <div id="sidebar" class="overflow-y-scroll lg:overflow-y-auto fixed lg:sticky h-full lg:h-auto z-40 top-0 bg-gray-900 pt-10 w-64 lg:w-72">
            <div class="px-8">
                <div class="flex items-center justify-between">
                    <div class="w-32">
                        <img class="w-full" src="https://cdn.tuk.dev/assets/components/todos/logo.png"
                            alt="quicklist logo">
                    </div>
                ...
                <ul class="my-10 flex flex-wrap">
                    <li 
                        class="w-1/2 flex justify-start mb-6">
                        <router-link to="/"
                            v-bind:class="[{'bg-gray-700' :$route.path === '/'}, {'text-gray-600' :$route.path !== '/'}]"
                            class="bg-transparent rounded-md text-gray-300 flex flex-col justify-center items-center w-20 h-20 p-4">
                    ...
                    <li class="w-1/2 flex justify-end mb-6">
                        <router-link to="/inbox"
                            v-bind:class="[{'bg-gray-700' :$route.path === '/inbox'}, {'text-gray-600' :$route.path !== '/inbox'}]"
                            class="rounded-md text-gray-300 flex flex-col justify-center items-center w-20 h-20 p-4">
                    ...
                    <li class="w-1/2 flex justify-start mb-6">
                        <router-link to="/notebook"
                            v-bind:class="[{'bg-gray-700' :$route.path === '/notebook'}, {'text-gray-600' :$route.path !== '/notebook'}]"
                    ...
                    <li class="w-1/2 flex justify-end mb-6">
                        <router-link to="/calendar"
                            v-bind:class="[{'bg-gray-700' :$route.path === '/calendar'}, {'text-gray-600' :$route.path !== '/calendar'}]"
                            class="rounded-md bg-transparent text-gray-600 flex flex-col justify-center items-center w-20 h-20 p-4">
                    ...
                    <li class="w-1/2 flex justify-start">
                        <router-link to="/important"
                            v-bind:class="[{'bg-gray-700' :$route.path === '/important'}, {'text-gray-600' :$route.path !== '/important'}]"
                            class="rounded-md bg-transparent text-gray-600 flex flex-col justify-center items-center w-20 h-20 p-4">
                    ...
                    <li class="w-1/2 flex justify-end">
                        <router-link to="/projects"
                            v-bind:class="[{'bg-gray-700' :$route.path === '/projects'}, {'text-gray-600' :$route.path !== '/projects'}]"
                            class="rounded-md bg-transparent text-gray-600 flex flex-col justify-center items-center w-20 h-20 p-4">
                ...
                <div class="flex items-center justify-between text-gray-600">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer icon icon-tabler icon-tabler-plus"
                ...
                <div class="my-20">
                    ...
                    <ul class="text-gray-600 mt-8">
                        <li 
                            v-for="(label, idx) in labels" v-bind:key="idx"
                            class="mb-5 flex items-center">
                            <span 
                                v-bind:class="label.theme"
                                class="mr-2 w-2 h-2 rounded-full"></span>
                            {{label.title}}
                        </li>
            ...
            <div class="px-8 py-4 w-full border-t border-gray-800 flex items-center text-gray-600 uppercase text-xs">
                <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer icon icon-tabler icon-tabler-trash"
...
<script>
import SideBarHandler from "@/mixins/index"
export default {
