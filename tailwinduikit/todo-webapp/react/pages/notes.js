    ...
    return (
        <>
            <div className="py-8 px-12 w-full">
                <div className="mb-6 md:mb-12 md:flex items-center w-full justify-between">
                        ...
                        <div className="flex items-center md:hidden ml-6 md:ml-0">
                            <div className="mr-2 md:mr-6">
                                <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 28 28" fill="none">
                                    <path d="M11.6667 5.83333C11.6667 4.54467 12.7113 3.5 14 3.5C15.2887 3.5 16.3333 4.54467 16.3333 5.83333C19.0635 7.12431 20.8584 9.81662 21 12.8333V16.3333C21.178 17.8043 22.044 19.1032 23.3333 19.8333H4.66666C5.95596 19.1032 6.82195 17.8043 7 16.3333V12.8333C7.14159 9.81662 8.93647 7.12431 11.6667 5.83333" stroke="#718096" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"></path>
                                    <path d="M10.5 19.8333V21C10.5 22.933 12.067 24.5 14 24.5C15.933 24.5 17.5 22.933 17.5 21V19.8333" stroke="#718096" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"></path>
                                </svg>
                            </div>
                ...
                <div className="flex items-center justify-between mb-10">
                    ...
                    <div onClick={() => Popup(true)} className="cursor-pointer w-10 h-10 bg-gray-900 text-white rounded-full flex justify-center items-center">
                    ...
                    <div id="popup" className="absolute hidden  inset-0 z-50 overflow-y-scroll">
                        <div onClick={() => Popup(false)} className="absolute inset-0 bg-gray-900  bg-opacity-75 z-0" />
                        <div className="flex w-full justify-end min-h-screen lg:h-full">
                            <div className="bg-white w-full md:w-11/12 xl:w-2/5 pt-12 px-12 h-full z-50">
                                <div className="container flex flex-col w-full h-full justify-between">
                                    <div>
                                        <div className="flex w-full justify-between items-center">
                                            <h2 className="text-4xl font-bold text-dark">Compose Note</h2>
                                            <div onClick={() => Popup(false)} className="block lg:hidden ml-5">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-x" width={32} height={32} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" />
                                        ...
                                        <div className="flex flex-col items-start md:flex-row w-full md:items-center py-1 bg-custom-gray-1 mt-12">
                                            <div className="relative ">
                                                <select className="focus:outline-none md:border-r border-gray-300 bg-transparent text-xs  appearance-none cursor-pointer text-sm py-3 pl-4 pr-12 text-gray-700">
                                            ...
                                            <div className="flex items-center">
                                                <div className="w-10 h-10 cursor-pointer px-2 bg-custom-gray-2 ml-2 flex items-center justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={13} height={14} viewBox="0 0 13 14" fill="none">
                                                        ...
                                                        <g mask="url(#mask0)">
                                                            <rect x="-2.83337" y="-2.33337" width="18.6667" height="18.6667" fill="#333333" />
                                                        </g>
                                                    </svg>
                                                </div>
                                                <div className="w-10 h-10 cursor-pointer bg-transparent  flex items-center justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={19} height={20} viewBox="0 0 19 20" fill="none">
                                                        ...
                                                        <g mask="url(#mask1)">
                                                            <rect x="0.166626" y="0.666626" width="18.6667" height="18.6667" fill="#333333" />
                                                        </g>
                                                    </svg>
                                                </div>
                                                <div className="w-10 h-10 cursor-pointer bg-transparent  flex items-center justify-center">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <div className="w-10 h-10  cursor-pointer bg-transparent  flex items-center justify-center">
                                                    <img src="https://cdn.tuk.dev/assets/components/todos/button-table.png" alt="button-table" srcSet />
                                                </div>
                                                <div className="w-10 h-10 cursor-pointer bg-transparent  ml-2 flex items-center justify-center">
                                                    <img src="https://cdn.tuk.dev/assets/components/todos/button-media-embed.png" alt="button-media-embed" srcSet />
                                                </div>
                                                <div className="w-10 h-10 cursor-pointer bg-transparent  flex items-center justify-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width={29} height={28} viewBox="0 0 29 28" fill="none">
                                                        <g opacity="0.5">
                                        ...
                                        <div className="mt-10 border-b border-gray-400 ">
                                            <input className="w-full text-2xl font-bold pb-2 focus:outline-none placeholder-gray-400 " placeholder="Weekend Plan and Errands" type="text" />
                                        </div>
                                        <div className="text-sm text-gray-dark mt-8">
                                        ...
                                        <div className="flex w-20 items-center border py-1 px-3 border-gray-300 rounded-md my-9 ">
                                            <div className="w-2 h-2 bg-custom-orange-2 rounded-full mr-2" />
                                            <p className="text-xs text-dark">Family</p>
                                        </div>
                                    </div>
                                    <div className="mt-4 md:mt-0">
                                        <div>
                                            <p className="text-base text-orange mb-6">This task is scheduled for 9th September 2020 at 18:00</p>
                                        </div>
                                        <div className="md:flex justify-between w-full py-4 border-t border-gray-400">
                                            ...
                                            <div className="mt-4 md:mt-0">
                                                <button onClick={() => Popup_review(true)} className="text-sm text-white focus:outline-none py-3 px-6 bg-custom-orange-2 rounded-md">
                                                    Save Task
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div id="popup_review" className="absolute hidden  inset-0 z-50 overflow-y-scroll">
                        <div onClick={() => Popup_review(false)} className="absolute inset-0 bg-gray-900  bg-opacity-75 z-0" />
                        <div className="flex w-full justify-end min-h-screen z-50 lg:h-full">
                            <div className="bg-white w-full md:w-11/12 xl:w-2/5 pt-12 px-12  z-50">
                                <div className="container flex flex-col w-full h-full justify-between">
                                    <div>
                                        <div className="flex items-center">
                                            <h2 className="text-4xl font-bold text-dark">Review Note</h2>
                                            <div onClick={() => Popup_review(false)} className="block lg:hidden ml-5">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-x" width={32} height={32} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" />
                                                    <line x1={18} y1={6} x2={6} y2={18} />
                                                    <line x1={6} y1={6} x2={18} y2={18} />
                                    ...
                                    <div>
                                        <div className="flex justify-end w-full  border-t border-gray-400 py-4 ">
                                            <div>
                                                <button className="text-sm text-orange border-custom-orange focus:outline-none py-3 px-6 bg-transparent">Save Task</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div className="rounded">
                        <div className="w-full h-64 flex flex-col justify-between bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4">
                            <div>
                                ...
                                <p className="text-gray-800 text-sm">Probabo, inquit, sic agam, ut labore et voluptatem sequi nesciunt, neque porro quisquam est, quid malum, sensu iudicari, sed ut alterum.</p>
                            </div>
                            <div>
                    ...
                    <div className="rounded">
                        <div className="w-full h-64 flex flex-col justify-between items-start bg-white rounded-lg border border-gray-400 mb-6 py-5 px-4">
                            <div>
                                <h4 className="text-gray-800 font-bold mb-3">13 things to work on</h4>
                                <p className="text-gray-800 text-sm">Probabo, inquit, sic agam, ut labore et voluptatem sequi nesciunt, neque porro quisquam est, quid malum, sensu iudicari</p>
                            </div>
                        ...
                        <div className="w-full h-64 flex flex-col justify-between bg-gray-300 rounded-lg border border-gray-300 mb-6 py-5 px-4">
                            <div>
                                <h4 className="text-gray-800 font-bold mb-3">13 things to work on</h4>
                                <p className="text-gray-800 text-sm">Probabo, inquit, sic agam, ut labore et voluptatem sequi nesciunt, neque porro quisquam est, quid malum, sensu iudicari, sed ut alterum.</p>
                            </div>
