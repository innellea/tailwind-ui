        ...
        <>
            <div className="py-8 px-10 md:px-12 w-full">
                ...
                <div className="flex items-center justify-between mb-10">
                    <h1 className="text-5xl font-bold text-gray-900">Inbox</h1>
                    ...
                    <div id="popup" className="fixed overflow-y-scroll hidden  inset-0 z-50">
                        ...
                        <div className="flex w-full justify-end w-full">
                            <div className="bg-white w-full md:w-11/12 xl:w-2/5 pt-12 px-12 min-h-screen z-50">
                                <div className="container flex flex-col w-full h-full justify-between">
                                    <div>
                                        <div className="flex w-full justify-between items-center">
                                            <h2 className="text-4xl font-bold text-dark">Compose Task</h2>
                                        ...
                                        <div className="mt-10 border-b border-gray-400 ">
                                            <input className="w-full text-2xl font-bold pb-2 focus:outline-none placeholder-gray-400 " placeholder="Fix Car Foundation" type="text" />
                                        </div>
                                        <div className="mt-12">
                                        ...
                                        <div className="flex items-center mt-16">
                                            <div className="flex items-center px-3 py-2 border-gray-300 border rounded-full">
                                                ...
                                                <p className="text-gray-600 ml-2 text-xs">7 Sept, 23:00 </p>
                                            </div>
                                            <div className="px-3 py-2 border border-gray-300 rounded-lg ml-5">
                                                <p className="text-gray-600  text-xs ">Personal Work </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mt-4 md:mt-0">
                                        ...
                                        <div className="md:flex justify-between w-full py-4 border-t border-gray-400">
                                            ...
                                            <div className="mt-4 md:mt-0">
                                                <button className="text-sm text-white focus:outline-none py-3 px-6 bg-custom-orange-2 rounded-md">Save Task</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div>
                    <div className="flex pt-6 items-center">
                        ...
                        <h1 className="text-lg text-gray-900 font-semibold ml-3">Overdue</h1>
                    </div>
                    {show == 0 && (
                        <ul className="pt-6">
                ...
                <div>
                    <div className="flex pt-6 items-center">
                        ...
                        <h1 className="text-lg text-gray-900 font-semibold ml-3">Urgent</h1>
                    </div>
                    {show == 1 && (
                        <ul className="pt-6">
                            <li className="md:flex justify-between items-center">
                    ...
                    <div className="flex pt-6 items-center">
                        <div className="cursor-pointer">
                            {show == 2 ? (
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setShow(2)} aria-label="Hide" className=" icon icon-tabler icon-tabler-chevron-up" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                                    <polyline points="6 15 12 9 18 15" />
                                </svg>
                            )}
                        </div>
                        <h1 className="text-lg text-gray-900 font-semibold ml-3">This week</h1>
                    </div>
                    {show == 2 && (
                        <ul className="pt-6 ">
                            <li className="md:flex justify-between items-center">
                    ...
                    <div className="flex pt-6 items-center">
                        <div className="cursor-pointer">
                            {show == 3 ? (
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setShow(3)} aria-label="Hide" className=" icon icon-tabler icon-tabler-chevron-up" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                                    <polyline points="6 15 12 9 18 15" />
                                </svg>
                            )}
                        </div>
                        <h1 className="text-lg text-gray-900 font-semibold ml-3">Unscheduled</h1>
                    </div>
                    {show == 3 && (
                        <ul className="pt-6 ">
                            <li className="md:flex justify-between items-center">
                    ...
                    <div className="flex pt-6 items-center">
                        <div className="cursor-pointer">
                            {show == 4 ? (
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setShow(4)} aria-label="Hide" className=" icon icon-tabler icon-tabler-chevron-up" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="#718096" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                                    <polyline points="6 15 12 9 18 15" />
                                </svg>
                            )}
                        </div>
                        <h1 className="text-lg text-gray-900 font-semibold ml-3">Completed</h1>
                    </div>
                    {show == 4 && (
                        <ul className="pt-6 ">
                            <li className="md:flex justify-between items-center">
