<template>
  <div class="f-f-p">
    <div class="mx-auto container relative px-6 xl:px-0">
      <nav>
        <div class="lg:flex justify-between w-full py-12 hidden">
          ...
          <div class="lg:w-2/3 xl:w-1/2">
            <ul class="font-normal text-lg flex justify-between items-center text-color-gray-light">
              <li class="text-color-purple cursor-pointer">
                <a href="#">Home</a>
              </li>
        ...
        <div class="flex py-2 justify-between items-center">
          ...
          <div class="visible flex items-center">
            ...
            <div class="xl:hidden">
              ...
              <div id="close" class="hidden close-m-menu" v-on:click="MenuHandler(false)">
                <svg
                  aria-label="Close"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
      ...
      <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 items-center">
        <div class="xl:mt-8">
          <div class="text-3xl lg:text-6xl xl:text-8xl text-color-gray tracking-1px font-extrabold">
            <h1 class="mt-2 lg:mt-0">Trustworthy</h1>
            <h1 class="mt-2 lg:mt-0 text-color-purple">Insurance</h1>
            <h1 class="mt-2 lg:mt-0">Providers</h1>
          </div>
          <h2
            class="text-lg lg:text-2xl tracking-wide leading-9 lg:w-10/12 mt-2 lg:mt-6 text-color-gray-light"
          >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque suspendisse est mi</h2>
          <button
            class="flex items-center relative focus:outline-none justify-center mt-5 lg:mt-10 text-lg lg:text-2xl font-medium text-white p-4 lg:p-8 bg-color-purple rounded-3xl"
          >
            Get a quote
            <svg
              class="ml-8"
        ...
        <div class="w-full custom-height bg-purple-light mt-8 lg:mt-0 rounded-3xl relative">
          <div class="-ml-8 xl:-ml-20 w-1/3">
            <img loading="lazy" class src="https://cdn.tuk.dev/assets/templates/intertia/cloud_1.png" alt="cloud" />
          </div>
          <div class="w-full flex justify-center">
            <img
              loading="lazy"
              class="absolute inset-0 m-auto w-2/3 md:-mb-20 xl:-mb-40"
              src="https://cdn.tuk.dev/assets/templates/intertia/Saly15.png"
              alt="saly"
            />
          </div>
          <div class>
            <img
              loading="lazy"
              class="absolute xl:-mt-10 w-1/4 right-0"
          ...
          <div class>
            <img
              loading="lazy"
              class="absolute ml-16 xl:ml-20 pb-14 xl:pb-20 w-1/5 left-0 bottom-0"
              src="https://cdn.tuk.dev/assets/templates/intertia/cloud_2.png"
              alt="cloud"
            />
          </div>
    ...
    <div class="mx-auto container my-20 lg:mt-48 lg:mb-24">
      <div class="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
          ...
          <div class="text-color-gray pl-12 w-1/2">
        ...
        <div class="flex justify-center w-full lg:border-r border-gray-300 py-6">
          ...
          <div class="text-color-gray w-1/2 pl-12">
    ...
    <div class="bg-gray-light px-4 xl:px-0 py-16">
      <div class="mx-auto container">
        <div class="mb-4 lg:mb-20">
          <h1
            class="text-center text-2xl lg:text-5xl text-gray-light font-bold text-color-gray tracking-1px"
          >Choose your Insurance</h1>
          <h2
            class="text-base lg:text-lg text-center text-color-gray-light mt-5 tracking-wider"
          >Keep your Life Simple, Safe and Wealthy</h2>
        </div>
        <div class="flex flex-wrap justify-center">
          <div class="max-w-sm m-4 bg-white rounded-3xl shadow-md py-6 px-16">
            ...
            <div class="pt-5">
              <h1
                class="text-xl lg:text-2xl font-semibold tracking-wider text-color-gray"
              >Home Insurance</h1>
              <p
                class="mt-4 tracking-wider leading-8 text-base w-11/12 text-color-gray-light"
              >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra ultrices nunc, non at</p>
            </div>
          </div>
          <div class="max-w-sm m-4 bg-white rounded-3xl shadow-md py-6 px-16">
            <svg
    ...
    <div class="container mx-auto px-4 xl:px-0 my-12 lg:my-24">
      <div
      ...
      >
        <div>
          ...
          <h1
            class="mt-12 text-color-gray text-2xl lg:text-5xl font-bold tracking-wider"
          >Simplified Claims</h1>
          <p
            class="lg:w-8/12 text-color-gray-light mt-5 mb-5 lg:mb-12"
          >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam elementum nibh libero mauris vulputate neque. At condimentum vitae scelerisque consecte.</p>
          <button
            class="py-5 px-6 text-white bg-color-purple rounded-3xl text-base font-medium shadow"
          >Go to Claims</button>
        </div>
        <div class="flex justify-end w-full">
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  gradientUnits="userSpaceOnUse"
                >
                  <stop stop-color="#805AD5" stop-opacity="0.8" />
          ...
          <div class="flex flex-col items-center ml-8 lg:ml-16">
            <div class>
              <h1 class="text-base lg:text-4xl text-color-gray mt-6 lg:mt-0">Report Claim</h1>
              <p
                class="lg:w-9/12 mt-2 tracking-wide leading-8 text-sm lg:text-base text-color-gray-light"
              >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet tellus, mi ipsum ridiculus interdum. Odio sapien.</p>
            </div>
            <div class="mt-10 md:mt-10 sm:mt-36 lg:mt-20 xl:mt-32">
              <h1 class="text-base lg:text-4xl text-color-gray lg:mt-0">Claim Processing</h1>
              <p
                class="lg:w-9/12 mt-2 tracking-wide leading-8 text-sm lg:text-base text-color-gray-light"
              >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet tellus, mi ipsum ridiculus interdum. Odio sapien.</p>
            </div>
            <div class="mt-10 md:mt-10 sm:mt-32 lg:mt-16 xl:mt-28">
              <h1 class="text-base lg:text-4xl text-color-gray lg:mt-0">Final Settlement</h1>
              <p
                class="lg:w-9/12 mt-2 tracking-wide leading-8 text-sm lg:text-base text-color-gray-light"
              >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet tellus, mi ipsum ridiculus interdum. Odio sapien.</p>
            </div>
    ...
    <div class="bg-gray-light px-4 xl:px-0 py-20">
      <div class="mx-auto container">
        <div class="lg:flex flex-row-reverse items-center">
          <div>
            ...
            <h1
              class="text-2xl lg:text-5xl lg:w-2/3 mt-8 tracking-wide font-bold text-color-gray"
            >Reviews from Real Agency Owners</h1>

            <p
              class="lg:w-8/12 text-color-gray-light mt-5 mb-12"
            >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam elementum nibh libero mauris vulputate neque. At condimentum vitae scelerisque consecte.</p>
          </div>
          <div>
            <div class="bg-white shadow-md lg:w-10/12 rounded-3xl">
              <div class="py-8 px-10">
                <p
                  class="tracking-wide text-color-gray-light text-base leading-8 border-b border-gray-300 pb-4"
                >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sem ante cursus lobortis gravida. Eu vulputate quis dolor eget sed etiam suscipit in condimentum. Cras morbi tellus cursus et.</p>
                <div class="mt-4 lg:flex justify-between items-center">
                  <div class="flex items-center">
                    <div class>
                      <img loading="lazy" class src="https://cdn.tuk.dev/assets/templates/intertia/profile(1).png" alt="profile" srcset />
                    </div>
                    <div class="ml-6">
                      <h1 class="text-base font-semibold">Tony Stark</h1>
                      <h2 class="text-color-purple-light font-light mt-2">December 2020</h2>
                    </div>
                  </div>
            ...
            <div class="bg-white mt-8 shadow-md lg:w-10/12 rounded-3xl">
              <div class="py-8 px-10">
                ...
                <div class="mt-4 lg:flex justify-between items-center">
                  <div class="flex items-center">
                    <div class>
                      <img loading="lazy" class src="https://cdn.tuk.dev/assets/templates/intertia/profile(2).png" alt="profile" srcset />
                    </div>
                    <div class="ml-6">
                      <h1 class="text-base font-semibold">Tony Stark</h1>
                      <h2 class="text-color-purple-light font-light mt-2">December 2020</h2>
            ...
            <div class="bg-white mt-8 shadow-md lg:w-10/12 rounded-3xl">
              <div class="py-8 px-10">
                ...
                <div class="mt-4 lg:flex justify-between items-center">
                  <div class="flex items-center">
                    <div class>
                      <img loading="lazy" class src="https://cdn.tuk.dev/assets/templates/intertia/profile(3).png" alt="profile" srcset />
                    </div>
                    <div class="ml-6">
                      <h1 class="text-base font-semibold">Tony Stark</h1>
                      <h2 class="text-color-purple-light font-light mt-2">December 2020</h2>
    ...
    <div class="mx-auto container px-4 xl:px-0 mt-14">
      <h1 class="text-xl lg:text-4xl tracking-1px text-center text-color-gray">Start 14 Day Trial</h1>
      <h2
        class="text-base tracking-wider text-center pt-3 text-color-gray-light"
      >Get Started, no Credit Card Required</h2>
      <div class="xl:flex items-center lg:mt-12">
        <div class="mt-6 lg:mt-0">
          ...
          <h1
            class="pr-2 mt-8 text-color-gray text-2xl lg:text-5xl font-bold tracking-1px lg:w-10/12 leading-9"
          >Honest Pricing, No Hidden Fees</h1>
          <p
            class="w-10/12 lg:w-7/12 leading-8 text-color-gray-light mt-5 mb-12"
          >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lacus in lectus tortor tempus, at volutpat, porta nec amet.</p>
        </div>
        <div class="lg:flex items-center">
          <div class="flex-shrink-0 px-11 py-12 bg-card-gray rounded-3xl mt-6 lg:mt-0">
            <h1 class="text-3xl lg:text-4xl font-medium text-color-gray pb-12 tracking-wider">Basic</h1>
            <h2 class="text-4xl lg:text-6xl xl:text-7xl font-bold text-color-gray tracking-wider">
              $18
              <span class="text-2xl lg:text-4xl">/month</span>
            </h2>
            <div class="mt-12">
              <div class="flex items-center relative text-color-gray">
              ...
              <div class="flex items-center relative mt-8">
                <label class="container1 block relative cursor-pointer">
            ...
            <div class="mt-16 flex justify-start">
              <button
                class="py-3 lg:py-6 pl-6 lg:pl-12 pr-8 bg-color-purple rounded-3xl text-white focus:outline-none text-lg xl:text-2xl tracking-widerw-auto lg:w-full flex items-center justify-between"
              >
                Start Trial
                <svg
                  class="ml-6 lg:ml-0 w-6 lg:w-auto"
                  xmlns="http://www.w3.org/2000/svg"
                  width="37"
                  height="32"
                  viewBox="0 0 37 32"
          ...
          <div class="px-11 py-12 bg-color-purple rounded-3xl mt-6 lg:mt-0 lg:ml-8 flex-shrink-0">
            <h1 class="text-3xl lg:text-4xl font-medium text-white pb-12 tracking-wider">Pro</h1>
            <h2 class="text-4xl lg:text-6xl xl:text-7xl font-bold text-white tracking-wider">
              $32
              <span class="text-2xl xl:text-4xl">/month</span>
            </h2>
            <div class="mt-12">
            ...
            <div class="mt-16 flex justify-start">
              <button
                class="py-3 lg:py-6 pl-6 lg:pl-12 pr-8 bg-white text-color-purple rounded-3xl focus:outline-none text-lg xl:text-2xl tracking-wider w-auto lg:w-full flex items-center justify-between"
              >
                Start Trial
                <svg
                  class="ml-6 lg:ml-0 w-6 lg:w-auto"
    ...
    <div class="mx-auto container px-4 xl:px-0 my-24">
      ...
      >We try to answer most of your Questions.</h2>
      <div class="lg:flex flex-wrap my-20 text-lg">
        <div class="lg:w-1/2 lg:pr-6">
          <div>
            <div
              class="flex py-2 xl:py-4 mb-4 justify-between items-center border-b border-gray-200"
            >
              <h1
                class="text-color-gray-light tracking-wide"
              >Which are the network hospitals in your vicinity?</h1>
            ...
            <ul class="hidden">
              <li class="sm:pt-4 sm:pb-8 pt-2 pb-4">
                <p
                  class="text-gray-800 text-lg xl:w-10/12 w-full mb-4"
                >What does lorem ipsum actually mean?</p>
                <p
                  class="xl:w-10/12 w-full text-gray-600 text-sm"
                >It provides a very simple start, no need to write a lot of code, you just import it and start the primitive components and create the ones you need.</p>
              </li>
            </ul>
          </div>
          <div>
      ...
      <div class="w-full flex justify-center items-center">
        <div class="bg-white lg:w-8/12 shadow-lg py-8 px-8 rounded-2xl">
          <div class="lg:flex justify-between w-full">
            <div>
              <h1 class="text-2xl lg:text-5xl text-color-gray font-bold tracking-wide">
                <span class="text-color-purple">Insurance</span> made Easy
              </h1>
              <h2
                class="text-color-gray-light tracking-wide text-base lg:text-lg mt-6"
              >At Inertia, we are commited to provide top-notch services to our customers</h2>
            </div>
            <div class="mt-4 lg:mt-0 flex-shrink-0">
              <button
                class="py-2 lg:py-4 focus:outline-none px-4 lg:px-8 lg:text-2xl text-white bg-color-purple tracking-wider rounded-3xl font-bold"
              >Get a quote</button>
            </div>
          </div>
        </div>
    ...
    <div class="bg-color-purple px-4 lg:px-0 py-10 lg:py-32">
      <div class="w-full lg:flex justify-between mx-auto container">
        ...
        <div class="w-full lg:w-1/2 mt-10 lg:mt-0 flex justify-center lg:justify-end">
          <div class="w-10/12 lg:w-1/2">
            <h1
              class="text-lg text-white font-semibold tracking-wide mb-6 text-center lg:text-left"
            >Subscribe to our Newsletter</h1>
            <div class="flex justify-center">
              <div
                class="w-full bg-white rounded-2xl flex justify-center items-center rounded relative"
              >
                <input
                  type="email"
                  required
                ...
                <button
                  type="submit"
                  class="absolute right-0 inset-y-0 h-full focus:outline-none transition duration-150 border-l border-gray-300 text-xs lg:text-base font-medium text-color-purple ease-in-out rounded text-white px-2 sm:px-6 py-2 lg:py-4"
                >Subscribe</button>
              </div>
            </div>
          </div>
    ...
    <div class="bg-color-gray py-5">
      <h1 class="text-base text-color-gray-light text-center">©2020 - Inertia. All right reserved</h1>
    </div>
  </div>
</template>
