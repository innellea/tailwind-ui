            ...
            <div className="2xl:mx-auto 2xl:container xl:px-0 px-4">
                <div className="flex flex-wrap items-center justify-between relative py-10 lg:py-28 2xl:px-0 xl:px-16 px-0">
                    <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex 2xl:w-96">
                                    <img src="https://cdn.tuk.dev/assets/templates/radian/team(1).png" alt="oliver" className="w-full" />
                                    <div className="overlay2 flex justify-center items-center">
                                ...
                                <h4 className="text-2xl text-dark2 font-semibold mt-2">Oliver Queen</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke="#5A67D8" strokeWidth={3} />
                                    </svg>
                                    <h5 className="text-dark2 text-lg mt-2 font-medium">Founder, CEO</h5>
                                </div>
                            </div>
                        </div>
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex 2xl:w-96">
                                    <img src="https://cdn.tuk.dev/assets/templates/radian/team(2).png" alt="Thea" className="w-full" />
                                    <div className="overlay2 flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                            <path
                                                d="M20.67 30V18.39H24.5583L25.14 13.8767H20.67V10.9967C20.67 9.69 21.0333 8.79833 22.9067 8.79833H25.2967V4.76167C24.1397 4.63891 22.9768 4.57937 21.8133 4.58333C18.3683 4.58333 16.01 6.68667 16.01 10.55V13.8767H12.1133V18.39H16.01V30H1.66667C1.22464 30 0.800716 29.8244 0.488155 29.5118C0.175595 29.1993 0 28.7754 0 28.3333V1.66667C0 1.22464 0.175595 0.800716 0.488155 0.488155C0.800716 0.175595 1.22464 0 1.66667 0H28.3333C28.7754 0 29.1993 0.175595 29.5118 0.488155C29.8244 0.800716 30 1.22464 30 1.66667V28.3333C30 28.7754 29.8244 29.1993 29.5118 29.5118C29.1993 29.8244 28.7754 30 28.3333 30H20.67Z"
                                ...
                                <h4 className="text-2xl text-dark2 font-semibold mt-2">Thea Queen</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={42} height={4} viewBox="0 0 42 4" fill="none">
                                        <line y1={2} x2="41.5939" y2={2} stroke="#5A67D8" strokeWidth={3} />
                                    </svg>
                                    <h5 className="text-dark2 text-lg mt-2 font-medium tracking-wider">Senior Architect</h5>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex 2xl:w-96">
                                    <img src="https://cdn.tuk.dev/assets/templates/radian/team(3).png" alt="John" className="w-full" />
                                    <div className="overlay2 flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                            <path
                                                d="M20.67 30V18.39H24.5583L25.14 13.8767H20.67V10.9967C20.67 9.69 21.0333 8.79833 22.9067 8.79833H25.2967V4.76167C24.1397 4.63891 22.9768 4.57937 21.8133 4.58333C18.3683 4.58333 16.01 6.68667 16.01 10.55V13.8767H12.1133V18.39H16.01V30H1.66667C1.22464 30 0.800716 29.8244 0.488155 29.5118C0.175595 29.1993 0 28.7754 0 28.3333V1.66667C0 1.22464 0.175595 0.800716 0.488155 0.488155C0.800716 0.175595 1.22464 0 1.66667 0H28.3333C28.7754 0 29.1993 0.175595 29.5118 0.488155C29.8244 0.800716 30 1.22464 30 1.66667V28.3333C30 28.7754 29.8244 29.1993 29.5118 29.5118C29.1993 29.8244 28.7754 30 28.3333 30H20.67Z"
                                ...
                                <h4 className="text-2xl text-dark2 font-semibold mt-2">John Diggle</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke="#5A67D8" strokeWidth={3} />
                                    </svg>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex 2xl:w-96">
                                    <img src="https://cdn.tuk.dev/assets/templates/radian/team(4).png" alt="Dinah" className="w-full" />
                                    <div className="overlay2 flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                            <path
                                                d="M20.67 30V18.39H24.5583L25.14 13.8767H20.67V10.9967C20.67 9.69 21.0333 8.79833 22.9067 8.79833H25.2967V4.76167C24.1397 4.63891 22.9768 4.57937 21.8133 4.58333C18.3683 4.58333 16.01 6.68667 16.01 10.55V13.8767H12.1133V18.39H16.01V30H1.66667C1.22464 30 0.800716 29.8244 0.488155 29.5118C0.175595 29.1993 0 28.7754 0 28.3333V1.66667C0 1.22464 0.175595 0.800716 0.488155 0.488155C0.800716 0.175595 1.22464 0 1.66667 0H28.3333C28.7754 0 29.1993 0.175595 29.5118 0.488155C29.8244 0.800716 30 1.22464 30 1.66667V28.3333C30 28.7754 29.8244 29.1993 29.5118 29.5118C29.1993 29.8244 28.7754 30 28.3333 30H20.67Z"
                                ...
                                <h4 className="text-2xl text-dark2 font-semibold mt-2">Dinah Lance</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke="#5A67D8" strokeWidth={3} />
                                    </svg>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex 2xl:w-96">
                                    <img src="https://cdn.tuk.dev/assets/templates/radian/team(5).png" alt="sarah" className="w-full" />
                                    <div className="overlay2 flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                            <path
                                                d="M20.67 30V18.39H24.5583L25.14 13.8767H20.67V10.9967C20.67 9.69 21.0333 8.79833 22.9067 8.79833H25.2967V4.76167C24.1397 4.63891 22.9768 4.57937 21.8133 4.58333C18.3683 4.58333 16.01 6.68667 16.01 10.55V13.8767H12.1133V18.39H16.01V30H1.66667C1.22464 30 0.800716 29.8244 0.488155 29.5118C0.175595 29.1993 0 28.7754 0 28.3333V1.66667C0 1.22464 0.175595 0.800716 0.488155 0.488155C0.800716 0.175595 1.22464 0 1.66667 0H28.3333C28.7754 0 29.1993 0.175595 29.5118 0.488155C29.8244 0.800716 30 1.22464 30 1.66667V28.3333C30 28.7754 29.8244 29.1993 29.5118 29.5118C29.1993 29.8244 28.7754 30 28.3333 30H20.67Z"
                                ...
                                <h4 className="text-2xl text-dark2 font-semibold mt-2">Sarah Lance</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke="#5A67D8" strokeWidth={3} />
                                    </svg>
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex 2xl:w-96">
                                    <img src="https://cdn.tuk.dev/assets/templates/radian/team(6).png" alt="Halena" className="w-full" />
                                    <div className="overlay2 flex justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                            <path
                                                d="M20.67 30V18.39H24.5583L25.14 13.8767H20.67V10.9967C20.67 9.69 21.0333 8.79833 22.9067 8.79833H25.2967V4.76167C24.1397 4.63891 22.9768 4.57937 21.8133 4.58333C18.3683 4.58333 16.01 6.68667 16.01 10.55V13.8767H12.1133V18.39H16.01V30H1.66667C1.22464 30 0.800716 29.8244 0.488155 29.5118C0.175595 29.1993 0 28.7754 0 28.3333V1.66667C0 1.22464 0.175595 0.800716 0.488155 0.488155C0.800716 0.175595 1.22464 0 1.66667 0H28.3333C28.7754 0 29.1993 0.175595 29.5118 0.488155C29.8244 0.800716 30 1.22464 30 1.66667V28.3333C30 28.7754 29.8244 29.1993 29.5118 29.5118C29.1993 29.8244 28.7754 30 28.3333 30H20.67Z"
                                ...
                                <h4 className="text-2xl text-dark2 font-semibold mt-2">Helena Rosa</h4>
                                <div className="pb-4 px-5 mt-4 flex flex-col border-b-2 border-l-2 border-r-2 border-black w-full items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={3} height={31} viewBox="0 0 3 31" fill="none">
                                        <line x1="1.5" y1="-4.88672e-08" x2="1.5" y2={31} stroke="#5A67D8" strokeWidth={3} />
                                    </svg>
                    ...
                    <div className="flex flex-row xl:flex-col w-full xl:w-auto items-center 2xl:-mr-20 justify-center relative xl:absolute right-0 2xl:px-0 px-4">
                        ...
                        <a className="xl:hidden" href="./testimonials">
                        ...
                        <a className="ml-5 xl:hidden" href="./contacts">
