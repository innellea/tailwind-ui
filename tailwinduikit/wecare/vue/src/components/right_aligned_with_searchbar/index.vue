        ...
        <div class="w-full relative px-6 xl:px-0">
            ...
            <nav class="lg:hidden relative z-40">
                <div class="flex py-6 justify-between items-center px-4">
                    ...
                    <div class="flex items-center">
                        <ul id="list" class="hidden p-2 border-r bg-menu absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16">
            ...
            <nav class="hidden relative z-10 w-full lg:flex justify-between items-center p-20">
                ...
                <div class="w-5/6">
                    <div class="flex items-center justify-end">
                        <ul class="custom-gray-800 flex items-center leading-none">
                            <li><a href="#">Products</a></li>
                            <li class="ml-4"><a href="#">Claims</a></li>
                            <li class="ml-4"><a href="#">Renewal</a></li>
                            <li class="ml-4"><a href="#">Support</a></li>
                        </ul>
                        <div class="pl-40">
                            <button class="bg-blue-500 text-white px-6 py-2.5 font-semibold rounded focus:outline-none">Live Chat</button>
                        </div>
                    </div>
                </div>
            </nav>
            <div class="pt-32 lg:flex items-center relative z-10 container mx-auto">
                ...
                <div class="w-full lg:w-1/2 h-full">
                    <p class="text-blue-500 uppercase text-2xl mb-4">Qusique Tincidun sapien</p>
                    <h1 class="custom-gray-900 text-80px mb-8">All natural ingredients</h1>
                    <p class="custom-gray-800 font-regular mb-8">Vestibulum placerat scelerisque turpis, ut laoreet erat varius ut. Phasellus eleifend vitae augue a accumsan. Sed eu semper lorem. Nullam sodales lorem libero, ut viverra diam suscipit et. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Etiam ac posuere nunc.</p>
                    <div class="bg-white py-4 px-4 flex flex-col sm:flex-row justify-start sm:justify-between items-start sm:items-center shadow-lg rounded-lg">
                        <div class="sm:flex items-center py-2">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-500 icon icon-tabler icon-tabler-user" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <circle cx="12" cy="7" r="4" />
                                    <path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />
                                </svg>
                                <p class="leading-none tracking-normal custom-gray-800 ml-2.5">Doctor Name</p>
                            </div>
                            <div class="flex items-center sm:mx-4 xl:mx-14 my-6 lg:my-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-500 icon icon-tabler icon-tabler-layout-bottombar" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <rect x="4" y="4" width="16" height="16" rx="2" />
                                    <line x1="4" y1="15" x2="20" y2="15" />
                                </svg>
                                <p class="leading-none tracking-normal custom-gray-800 ml-2.5">Zip code</p>
                            </div>
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-500 icon icon-tabler icon-tabler-flag" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                ...
                                <p class="leading-none tracking-normal custom-gray-800 ml-2.5">Insurance</p>
                            </div>
                        </div>
                        <div class="text-white bg-blue-600 mt-4 sm:mt-0 p-3 rounded w-full sm:w-auto relative">
...
<script>
import MenuHandler from "@/mixins/index"
export default {
    mixins: [MenuHandler]
}
</script>
