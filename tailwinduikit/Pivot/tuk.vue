<template>
  <div class="">
    <div class="lg:px-6 xl:px-0">
      <div class="container mx-auto relative z-20">
        <nav class="w-full absolute">
          <div
            class="hidden lg:flex w-full f-f-p justify-between items-center py-6 relative"
          >
            <div class="w-2/3">
              <svg
            ...
            <div class="md:w-1/2 xl:w-1/3">
              <ul
                class="flex justify-between w-full items-center text-gray-600"
              >
                <li class="border-custom pb-1"><a href="">Home</a></li>
                <li class="border-custom-trans pb-1"><a href="">Stats</a></li>
                <li class="border-custom-trans pb-1"><a href="">Coins</a></li>
                <li class="border-custom-trans pb-1"><a href="">Blog</a></li>
                <li class="border-custom-trans pb-1">
                  <a href="">Contact Us</a>
                </li>
              </ul>
            </div>
      ...
      <div class="mx-auto container relative z-0 px-4 xl:px-0">
        <div class="flex flex-col-reverse md:flex-row">
          <div class="md:w-3/5 md:pt-24 pb-10 lg:py-32 xl:py-48">
            <h1
              class="text-3xl lg:text-6xl xl:text-8xl font-black text-color-heading text-center md:text-left tracking-tighter f-f-i md:w-7/12 leading-tight text-heading-color"
            >
              ONE WALLET TO RULE THEM ALL
            </h1>
            <h2
              class="md:w-8/12 py-4 text-center md:text-left md:py-8 text-colo-para text-lg lg:text-2xl"
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pharetra
              eget donec nulla tellus bibendum.
            </h2>
            <div class="w-full flex justify-center md:block">
              <button
                class="bg-background-blue py-3 px-10 lg:py-7 lg:px-20 rounded-full text-white text-sm md:text-lg f-f-p"
              >
                Learn More
              </button>
            </div>
          ...
          <div
            class="w-1/2 sm:w-2/5 h-64 md:h-auto m-auto flex items-center overflow-hidden"
          >
            <img
              class="md:absolute md:w-1/2 md:-ml-28"
              src="../assets/DeviceMacbookPro.png"
              alt=""
            />
          </div>
        </div>
    ...
    <div class="flex w-full justify-center mt-7 items-center">
      <a href="#blog">
        <button
          class="rounded-full custom-button-border py-3 px-3 focus:outline-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
    ...
    <div class="my-28 container mx-auto">
      <div class="flex justify-center w-full items-center">
        <div class="w-11/12 f-f-p">
          <div
            class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"
          >
            <div
              class="py-10 px-5 rounded-3xl bg-background-blue cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="32"
              ...
              <div class="mt-5">
                <h1 class="text-white text-2xl tracking-wide font-bold">
                  Coins
                </h1>
                <h2 class="text-white mt-2 leading-6 text-base tracking-wider">
                  Lorem ipsum dolor sit amet, con sectetur adipiscing elit.
                  Pharetra eget donec
                </h2>
              </div>
            </div>
            <div class="py-10 px-5 rounded-3xl bg-transparent cursor-pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="44"
                height="51"
              ...
              <div class="mt-5">
                <h1 class="text-color-heading text-2xl tracking-wide font-bold">
                  Transactions
                </h1>
                <h2
                  class="text-color-para mt-2 leading-6 text-base tracking-wider"
                >
    ...
    <div class="mx-auto container f-f-p px-4 xl:px-0">
      <h1
      ...
      <div class="md:mt-24 f-f-p">
        <div class="hidden md:flex justify-center w-full">
          ...
          >
            ...
            >
              <h1 class="text-2xl tracking-wide font-semibold">
                Create a Wallet
              </h1>
              <h2
                class="text-colo-para mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide"
              >
          ...
          >
            ...
            <div
              class="flex mt-12 flex-col items-center md:items-start md:w-8/12"
            >
              <h1 class="text-2xl tracking-wide font-semibold">
                SignUp for an Account
              </h1>
              <h2 class="text-colo-para mt-3 text-base leading-6 tracking-wide">
                Lorem ipsum dolor sit amet, consectetur adipiscing quisque in
                semper lacinia ante vestibulum nunc. Viverra sem ac, tellus
                viverra lacinia. Cras lacus.
              </h2>
        ...
        <div class="md:hidden flex flex-col items-center w-full">
          ...
          <div class="mt-10">
            <h1 class="text-2xl text-center tracking-wide font-semibold">
              SignUp for an Account
            </h1>
            <h2
              class="text-colo-para mt-3 text-center text-base leading-6 tracking-wide"
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing quisque in
              semper lacinia ante vestibulum nunc. Viverra sem ac, tellus
              viverra lacinia. Cras lacus.
          ...
          <div class="mt-10">
            <h1 class="text-2xl tracking-wide text-center font-semibold">
              Create a Wallet
            </h1>
            <h2
              class="text-colo-para mt-3 pl-3 text-center text-base leading-6 tracking-wide"
            >
              Lorem ipsum dolor sit amet, consectetur adipiscing quisque in
              semper lacinia ante vestibulum nunc. Viverra sem ac, tellus
              viverra lacinia. Cras lacus.
    ...
    <div class="mx-auto container px-4 xl:px-0 mt-16 lg:mt-32 f-f-p">
      ...
      <div class="w-full flex justify-center mt-12 lg:mt-24">
        <div class="hidden lg:block xl:w-11/12">
          <div
            class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8"
          >
            <div>
              <div class="flex items-center justify-end pb-12 xl:pr-10">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50"
                ...
                <div class="flex flex-col pl-8 xl:w-8/12">
                  <h2
                    class="text-base xl:text-2xl font-semibold tracking-wider text-color-heading"
                  >
                    Mobile App
                  </h2>
                  <p
                    class="text-colo-para leading-7 tracking-wide text-base mt-3"
                  >
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Pharetra eget donec
                  </p>
            ...
            <div>
              <div
                class="vl border-b border-gray-300 hidden lg:block absolute"
              ></div>
              <div
                class="flex items-center justify-end pb-12 lg:ml-8 xl:ml-0 xl:pr-10"
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              <div class="vl hidden lg:block absolute"></div>
              <div
                class="flex items-center justify-end pb-12 lg:ml-8 xl:ml-0 xl:pr-10"
              >
                <div>
          ...
          >
            <div>
              <div class="flex items-center justify-end pb-12 pr-10">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="46"
        ...
        <div class="flex lg:hidden flex-wrap justify-between">
          ...
          <div class="md:flex w-full justify-between items-center my-10">
            <div class="flex items-center">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="px-6 lg:px-12 mt-16 lg:mt-32 f-f-p">
      <h1
        class="text-center text-3xl lg:text-5xl tracking-wider text-color-heading mb-12 lg:mb-0"
      >
      ...
      <div class="slider">
        <div class="slide-ana">
          <div
            class="px-6 lg:px-0 flex flex-col lg:flex-row items-center w-full justify-between"
          >
            <div class="flex w-full justify-center">
              <div class="lg:flex lg:w-8/12 xl:w-1/2 relative justify-center">
                <svg
                  class="lg:absolute z-10 left-0 mb-2 lg:mb-0 lg:-ml-16"
                  xmlns="http://www.w3.org/2000/svg"
                  width="44"
                  height="37"
                  viewBox="0 0 44 37"
                ...
                <div
                  class="bg-white shadow-lg w-full py-20 px-5 rounded-3xl xl:px-10"
                >
                  <div class="lg:flex">
                    <img
                      class="w-28 h-28"
                      src="../assets/profilePicMask.png"
                      alt="profilePicMask"
                      srcset=""
                    />
                    <div class="flex flex-col lg:ml-12 mt-4 lg:mt-2">
                      <h1 class="text-2xl text-color-heading tracking-wide">
                        Alex Parkinson
                      </h1>
                      <h2
                        class="text-base text-color-heading tracking-wide mt-1"
                      >
                        CodeDraw Corp
                      </h2>
                      <p
                        class="text-base text-color-para tracking-wide leading-7 mt-3"
                      >
                ...
                <div
                  class="flex block lg:absolute lg:-mr-2 right-0 bottom-0 w-full justify-end mt-2 lg:mt-0 lg:pl-2"
                >
                  <svg
                    class="lg:absolute right-0 bottom-0 lg:-mr-12 mt-4 lg:mt-0"
                    xmlns="http://www.w3.org/2000/svg"
                    width="44"
                    height="37"
                    viewBox="0 0 44 37"
        ...
        <span
          class="left absolute inset-0 w-12 h-12 m-auto lg:ml-6 mb-6 lg:mb-auto"
          id="prev"
        >
          <svg
            class="cursor-pointer w-5 lg:w-auto"
            xmlns="http://www.w3.org/2000/svg"
            width="26"
            height="46"
            viewBox="0 0 26 46"
        ...
        ></span>
        <span
          class="right absolute inset-0 w-12 h-12 m-auto lg:mr-6 mb-6 lg:mb-auto"
          id="next"
        >
          <svg
            class="cursor-pointer w-5 lg:w-auto"
      ...
      <div class="hidden lg:flex items-center justify-center w-full">
        <div class="flex items-center justify-center">
          <div class="w-5 h-5 rounded-full bg-blue cursor-pointer"></div>
          <div class="w-3 h-3 rounded-full bg-gray ml-4 cursor-pointer"></div>
          <div class="w-3 h-3 rounded-full bg-gray ml-4 cursor-pointer"></div>
          <div class="w-3 h-3 rounded-full bg-gray ml-4 cursor-pointer"></div>
          <div class="w-3 h-3 rounded-full bg-gray ml-4 cursor-pointer"></div>
        </div>
    ...
    <div
      id="blog"
      class="bg-gray-light px-4 xl:px-0 py-12 mt-10 lg:mt-20 f-f-p"
    >
          ...
          >
            <div>
              <img
                ...
                alt="computer"
              />
              <div class="py-4 px-8 w-full flex justify-between bg-blue-dark">
              ...
              <div class="bg-white px-10 py-6 rounded-bl-3xl rounded-br-3xl">
                <h1
                  class="text-4xl text-color-heading font-semibold tracking-wider"
                >
                  Transactions
                </h1>
                <p
                  class="text-color-para text-lg leading-8 tracking-wide mt-6 w-11/12"
                >
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                ...
                >
                  <p class="text-base tracking-wide text-blue-light">
                    Read more
                  </p>
                  <svg
                    class="ml-3 lg:ml-6"
            ...
            <div>
              ...
              >
                <div>
                  ...
                  />
                  <div
                    class="py-2 px-4 w-full flex justify-between bg-blue-dark"
                  >
                    <p class="text-sm text-white font-semibold tracking-wide">
                      Bruce Wayne
                    </p>
                  ...
                  <div class="bg-white px-6 py-4 rounded-bl-3xl rounded-br-3xl">
                    <h1
                      class="text-lg text-color-heading font-semibold tracking-wider"
                    >
                      Transactions
                    </h1>
                    <p
                      class="text-color-para text-base leading-8 pr-4 tracking-wide mt-2"
                    >
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Pharetra eget donec...
                    </p>
    ...
    <div class="f-f-p mt-20">
      <h1
        class="text-center text-3xl lg:text-5xl tracking-wider text-color-heading"
      >
        Partnerships
      </h1>
      <div class="py-16 mt-12 lg:mt-24 bg-blue-dark">
        <div
          class="flex flex-col lg:flex-row items-center w-full justify-between mx-auto container"
        >
          <img class="" src="../assets/hero-imglogo.png" alt="GS1" />
          <img
            class="mt-10 lg:mt-0"
            src="../assets/hero-imglogo(1).png"
            alt="black-berry"
          />
          <img
            class="mt-10 lg:mt-0"
            src="../assets/hero-imglogo(2).png"
            alt="Honda"
          />
          <img
            class="mt-10 lg:mt-0"
            src="../assets/hero-imglogo(3).png"
            alt="Addidas"
          />
          <img
            class="mt-10 lg:mt-0"
            src="../assets/hero-imglogo(4).png"
            alt="Nike"
          />
        </div>
      </div>
    </div>
    <div class="f-f-p mt-16 lg:mt-32 mx-auto container px-4 xl:px-0">
      <h1
        class="text-center text-3xl lg:text-5xl tracking-wider text-color-heading"
      >
        Contact Us
      ...
      <div class="mt-12 lg:mt-24">
        ...
        >
          <div
            class="bg-white shadow-xl cursor-pointer custom-border-blue py-10 rounded-3xl flex flex-col items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="52"
            ...
            <h2
              class="text-lg font-bold tracking-wide mt-4 mb-5 text-color-heading"
            >
              Phone
            </h2>
            <p class="text-base font-semibold tracking-wide text-color-heading">
              +92 348 1234567
            </p>
            <p
              class="text-base font-semibold tracking-wide text-color-heading mt-4"
            >
              +92 348 1234567
            </p>
          </div>
          ...
          >
            ...
            <h2
              class="text-lg font-bold tracking-wide mt-4 mb-5 text-colo-para"
            >
              Location
            </h2>
            <div class="text-color-para text-base tracking-wide text-center">
    ...
    <div class="mx-auto f-f-p container lg:mt-24 mt-12 px-4 xl:px-0">
      <div
        class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-8"
      >
        <div class="flex flex-col my-8 lg:my-0 xl:my-0">
          ...
          >
            <span
              class="tracking-wide text-color-heading text-2xl font-semibold leading-10"
              >Name</span
            >
          </label>
          <input
    ...
    <div class="lg:mt-24 mt-12 mx-auto container">
      <img
        class="absolute hidden xl:block"
        src="../assets/iPhone-12.png"
        alt=""
      />
    </div>
    <div
      class="pb-5 pt-20 lg:pt-32 mt-20 lg:mt-40 bg-blue-dark px-4 xl:px-0 f-f-p"
    >
      <div class="mx-auto container">
        <div
          class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"
        >
          <div class="empty invisible hidden lg:block">234</div>
          <div class="">
            <div class="flex items-center">
              <div>
                <svg
              ...
              <div>
                <h1 class="text-white text-2xl font-semibold ml-5 mt-4">
                  is available on
                </h1>
              </div>
            </div>
          ...
          <div class="text-white flex flex-col lg:items-end">
            <div>
              <h2 class="text-2xl font-semibold">FEATURES</h2>
              <ul class="mt-2 text-lg">
                <li><a href="">Beginner’s Guide</a></li>
                <li class="mt-1"><a href="">Move to Servion</a></li>
                <li class="mt-1"><a href="">Website Builder</a></li>
                <li class="mt-1"><a href="">Tools and Resources</a></li>
              </ul>
            </div>
          </div>
          <div class="text-white flex flex-col lg:items-center">
            <div>
              <h2 class="text-2xl font-semibold">SUPPORT</h2>
              <ul class="mt-2 text-lg">
                <li><a href="">Help Center</a></li>
                <li class="mt-1"><a href="">Submit a Ticket</a></li>
        ...
        <div class="flex w-full lg:justify-end mt-7">
          <div class="flex items-center">
            <svg
        ...
        <div class="flex w-full lg:justify-end mt-7">
          <div class="xl:w-1/6 flex items-center text-white text-sm">
            <div class="pr-3 w-1/2 border-r border-white">
              <h4 class="cursor-pointer text-right">Terms of Service</h4>
            </div>
            <h4 class="pl-3 w-1/2 cursor-pointer">Privacy Policy</h4>
          </div>
        </div>
      </div>
    </div>
    <div class="bg-background-blue py-4">
      <div class="mx-auto container">
        <h5 class="text-white text-center text-sm tracking-wide font-semibold">
...
<script>
export default {
  name: "LightWithHeaderAndIconsAlternateStyle",
  data() {
    return {
      moved: true,
      dashboard: false,
...
.border-custom {
  border-bottom: 3px solid #237ac2;
}
.text-colo-para {
  color: #4a5568;
}
...
.custom-button-border {
  border: 2px solid #052e47;
}
.vl {
  border-left: 2px solid rgba(209, 213, 219);
  height: 138px;
}
.bg-blue {
  background: #4299e1;
...
.custom-border-blue {
  border-bottom: 20px solid #052e47;
}
.top-100 {
