      ...
      <nav className="flex-1 px-2 space-y-1 bg-white" aria-label="Sidebar">
            ...
            <div>
              ...
              <a href="/" className="bg-gray-100 text-gray-900 group w-full flex items-center pl-2 py-2 text-sm font-medium rounded-md">
                ...
                <svg className="text-gray-600 mr-3 h-6 w-6" data-todo-x-description="Heroicon name: outline/home" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
