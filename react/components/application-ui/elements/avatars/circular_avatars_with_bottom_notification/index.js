...
<div className="p-8 flex items-center justify-center bg-white">
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute bottom-0 right-0 block h-2 w-2 rounded-full ring-2 ring-white bg-red-400"></span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full ring-2 ring-white bg-gray-300"></span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute bottom-0 right-0 block h-3.5 w-3.5 rounded-full ring-2 ring-white bg-red-400"></span>
  </span>
