...
<div className="p-8 flex items-center justify-center bg-white">
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute top-0 right-0 block h-1.5 w-1.5 rounded-full ring-2 ring-white bg-gray-300"></span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute top-0 right-0 block h-3 w-3 rounded-full ring-2 ring-white bg-gray-300"></span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute top-0 right-0 block h-3.5 w-3.5 rounded-full ring-2 ring-white bg-red-400"></span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute top-0 right-0 block h-4 w-4 rounded-full ring-2 ring-white bg-green-400"></span>
  </span>
