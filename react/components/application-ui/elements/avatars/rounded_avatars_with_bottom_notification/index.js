...
<div className="p-8 flex items-center justify-center bg-white">
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute bottom-0 right-0 transform translate-y-1/2 translate-x-1/2 block border-2 border-white rounded-full">
      <span className="block h-2.5 w-2.5 rounded-full bg-gray-300"></span>
    </span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute bottom-0 right-0 transform translate-y-1/2 translate-x-1/2 block border-2 border-white rounded-full">
      <span className="block h-3.5 w-3.5 rounded-full bg-gray-300"></span>
    </span>
  </span>
  ...
  <span className="inline-block relative">
    ...
    <span className="absolute bottom-0 right-0 transform translate-y-1/2 translate-x-1/2 block border-2 border-white rounded-full">
      <span className="block h-4 w-4 rounded-full bg-gray-300"></span>
    </span>
  </span>
