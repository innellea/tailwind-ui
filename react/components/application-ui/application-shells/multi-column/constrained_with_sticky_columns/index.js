...
<div style={{maxHeight: "800px"}} _className="overflow-y-auto">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
            ...
            <div data-todo-at-click-away="open = false" className="flex-shrink-0 relative ml-5" data-todo-x-data="{ open: false }">
              <div>
                <button type="button" data-todo-at-click="open = !open" className="bg-white rounded-full flex focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu" aria-haspopup="true" data-todo-x-bind-aria-expanded="open">
      ...
      <div className="max-w-3xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-12 lg:gap-8">
        <div className="hidden lg:block lg:col-span-3 xl:col-span-2">
          <nav aria-label="Sidebar" className="sticky top-6 divide-y divide-gray-300">
            <x-placeholder>
              <div style={{height: "36rem"}} className="border-2 border-dashed border-gray-300 rounded-lg"></div>
            </x-placeholder>
          </nav>
        </div>
        <main className="lg:col-span-9 xl:col-span-6">
          <x-placeholder>
            <div className="px-4 sm:px-0">
              <div style={{height: "64rem"}} className="border-2 border-dashed border-gray-300 rounded-lg"></div>
            </div>
          </x-placeholder>
        </main>
