...
<div style={{minHeight: "712px"}} className="overflow-y-auto">
  ...
  <div className="min-h-screen bg-gray-100">
    <header data-todo-x-data="{ open: false }" className="pb-24 bg-indigo-600">
  ...
  <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd"></path>
          ...
          <div className="absolute right-0 flex-shrink-0 lg:hidden">
            {/* Mobile menu button */}
            <button data-todo-at-click="open = !open" className="bg-transparent p-2 rounded-md inline-flex items-center justify-center text-indigo-200 hover:text-white hover:bg-white hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-white" data-todo-x-bind-aria-expanded="open" aria-expanded="false">
