              ...
              <div>
                <a href="/" className="inline-flex space-x-4">
                  ...
                  <span className="inline-flex items-center text-sm font-medium text-rose-500 space-x-1">
                    ...
                    <svg className="h-5 w-5" data-todo-x-description="Heroicon name: chevron-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd"></path>
              ...
              <form action="#" className="mt-12 sm:max-w-lg sm:w-full sm:flex">
                <div className="min-w-0 flex-1">
                  ...
                  <input id="hero_email" type="email" className="block w-full border border-gray-300 rounded-md px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-rose-500 focus:ring-rose-500" placeholder="Enter your email">
                </div>
              ...
              <div className="mt-6">
                <div className="inline-flex items-center divide-x divide-gray-300">
                  <div className="flex-shrink-0 flex pr-5">
                    <svg className="h-5 w-5 text-yellow-400" data-todo-x-description="Heroicon name: star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <div className="relative sm:py-16 lg:py-0">
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
              ...
              <div className="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-rose-500" style={{mixBlendMode: "multiply"}}></div>
