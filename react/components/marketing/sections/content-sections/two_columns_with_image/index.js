          ...
          <div className="relative text-base mx-auto max-w-prose lg:max-w-none">
            <figure>
              ...
              <figcaption className="mt-3 flex text-sm text-gray-500">
                <svg className="flex-none w-5 h-5 text-gray-400" data-todo-x-description="Heroicon name: solid/camera" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
