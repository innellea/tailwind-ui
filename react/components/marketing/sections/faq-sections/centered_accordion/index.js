              ...
              <dt className="text-lg">
                <button data-todo-x-description="Expand/collapse question button" data-todo-at-click="openPanel = (openPanel === 0 ? null data-todo-colon- 0)" className="text-left w-full flex justify-between items-start text-gray-400" data-todo-x-bind-aria-expanded="openPanel === 0">
                  ...
                  <span className="ml-6 h-7 flex items-center">
                    <svg className="-rotate-180 h-6 w-6 transform" data-todo-x-description="Expand/collapse icon, toggle classes based on question open state.

Heroicon name: outline/chevron-down" data-todo-x-state-on="Open" data-todo-x-state-off="Closed" data-todo-x-bind-className="{ '-rotate-180': openPanel === 0, 'rotate-0': !(openPanel === 0) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
Heroicon name: outline/chevron-down" data-todo-x-state-on="Open" data-todo-x-state-off="Closed" data-todo-x-bind-className="{ '-rotate-180': openPanel === 1, 'rotate-0': !(openPanel === 1) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
</svg>
                  </span>
                </button>
...
Heroicon name: outline/chevron-down" data-todo-x-state-on="Open" data-todo-x-state-off="Closed" data-todo-x-bind-className="{ '-rotate-180': openPanel === 2, 'rotate-0': !(openPanel === 2) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
</svg>
                  </span>
                </button>
...
Heroicon name: outline/chevron-down" data-todo-x-state-on="Open" data-todo-x-state-off="Closed" data-todo-x-bind-className="{ '-rotate-180': openPanel === 3, 'rotate-0': !(openPanel === 3) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
</svg>
                  </span>
                </button>
...
Heroicon name: outline/chevron-down" data-todo-x-state-on="Open" data-todo-x-state-off="Closed" data-todo-x-bind-className="{ '-rotate-180': openPanel === 4, 'rotate-0': !(openPanel === 4) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
</svg>
                  </span>
                </button>
...
Heroicon name: outline/chevron-down" data-todo-x-state-on="Open" data-todo-x-state-off="Closed" data-todo-x-bind-className="{ '-rotate-180': openPanel === 5, 'rotate-0': !(openPanel === 5) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
</svg>
                  </span>
                </button>
