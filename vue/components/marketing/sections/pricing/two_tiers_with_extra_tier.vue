                    ...
                    <ul class="space-y-4">
                        ...
                        <li class="flex items-start">
                          <div class="flex-shrink-0">
                            <svg class="h-6 w-6 text-green-500" x-description="Heroicon name: check" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
