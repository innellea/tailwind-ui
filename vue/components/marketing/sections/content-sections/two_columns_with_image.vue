            ...
            <div class="relative text-base mx-auto max-w-prose lg:max-w-none">
              <figure>
                ...
                <figcaption class="mt-3 flex text-sm text-gray-500">
                  <svg class="flex-none w-5 h-5 text-gray-400" x-description="Heroicon name: camera" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
